...
public class DiaDia {
	...
	private boolean processaIstruzione(String istruzione) {
		if(istruzione.isEmpty())		//Guardie: Casi limite da gestire subito
			return false;

		//Da qui gestisco i casi ordinari
	...
	public void prendi(String nomeAttrezzo) {
		...
		if(this.partita.getGiocatore().getBorsa().addAttrezzo(attrezzo)) {		//Controllo che posso aggiungere l'attrezzo
			this.partita.getStanzaCorrente().removeAttrezzo(attrezzo);
			this.ioConsole.mostraMessaggio("Hai preso l'attrezzo");
		}else
	...
	public void posa(String nomeAttrezzo) {
		...
		if(this.partita.getStanzaCorrente().addAttrezzo(attrezzo)) {			//Controllo che posso aggiungere l'attrezzo
			this.partita.getGiocatore().getBorsa().removeAttrezzo(nomeAttrezzo);
			this.ioConsole.mostraMessaggio("Hai posato l'attrezzo");
		}else
